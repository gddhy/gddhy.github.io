...
module.exports = {
  ...
  gbk: {
    type: "_dbcs",
    table: function () { return (__webpack_require__(488).concat)(__webpack_require__(914)) }
  },
  xgbk: "gbk",
  isoir58: "gbk",
  ...
  cp949: {
    type: "_dbcs",
    table: function () { return __webpack_require__(166) }
  },
  ...
  big5hkscs: {
    type: "_dbcs",
    table: function () { return (__webpack_require__(324).concat)(__webpack_require__(267)) },
    encodeSkipVals: [
...
var Buffer = (__webpack_require__(774).Buffer)
...
var rclist_1 = __importDefault(__webpack_require__(373));
var base64_1 = __webpack_require__(542);
var RCEditor = /** @class */ (function () {
    function RCEditor() {
        this.activeCell = null;
        this.isReadStorage = false;
        this.rcList = new rclist_1.default();
        ...
        this.initSheet();
        // 从Storage读取rcfile
        var savedFile = localStorage.getItem('rcfile');
        var savedFileName = localStorage.getItem('rcfilename');
        if (savedFile && savedFileName && history.length > 1) {
            this.statusText.textContent = "\u6B63\u5728\u52A0\u8F7D: ".concat(savedFile);
            //将saveFile进行base64解码
            var decodedData = (0, base64_1.decodeBase64)(savedFile);
            var success = this.rcList.readData(savedFileName, decodedData);
            if (success) {
                this.initSheet(this.rcList.size());
                this.updateSheet();
                this.isReadStorage = true;
                this.statusText.textContent = "\u5DF2\u52A0\u8F7D: ".concat(savedFileName);
            }
            else {
                this.statusText.textContent = "\u52A0\u8F7D\u5931\u8D25: ".concat(savedFileName);
            }
        }
    ...
    RCEditor.prototype.initEventListeners = function () {
        var _this = this;
        var _a, _b;
        console.log('initEventListeners');
        (_a = document.getElementById('openFileBtn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () { return _this.fileInput.click(); });
        (_b = document.getElementById('saveFileBtn')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', function () { return _this.saveFile(); });
        this.fileInput.addEventListener('change', function (e) { return _this.handleFileSelect(e); });
    };
    RCEditor.prototype.handleFileSelect = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var input, file, data, _a, filename, success;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        filename = file.name;
                        this.statusText.textContent = "\u6B63\u5728\u52A0\u8F7D: ".concat(file.name);
                        try {
                            success = this.rcList.readData(filename, data);
                            if (success) {
                                this.initSheet(this.rcList.size());
                                this.updateSheet();
                                this.isReadStorage = false;
                                this.statusText.textContent = "\u5DF2\u52A0\u8F7D: ".concat(file.name);
                            }
                            else {
                                this.statusText.textContent = "\u52A0\u8F7D\u5931\u8D25: ".concat(file.name);
                            }
                        }
                        catch (error) {
                            console.error('加载文件错误:', error);
                            this.statusText.textContent = "\u52A0\u8F7D\u9519\u8BEF: ".concat(file.name);
                        }
                        return [2 /*return*/];
                }
            });
    ...
    RCEditor.prototype.saveFile = function () {
        return __awaiter(this, void 0, void 0, function () {
            var success, error_1, data, base64Data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!this.isReadStorage) return [3 /*break*/, 5];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.rcList.save()];
                    case 2:
                        success = _a.sent();
                        if (success) {
                            this.statusText.textContent = "\u5DF2\u4FDD\u5B58: ".concat(this.rcList.filename);
                        }
                        else {
    ...
    RCEditor.prototype.initSheet = function (rows) {
        var _this = this;
        ...
        var _loop_1 = function (row) {
            ...
            cell.addEventListener('focus', function () { return _this.handleCellFocus(cell, row); });
            cell.addEventListener('blur', function () { return _this.handleCellBlur(cell, row); });
            cell.addEventListener('input', function () { return _this.handleCellInput(cell, row); });
            cell.addEventListener('keydown', function (e) { return _this.handleCellKeyDown(e, cell, row); });
            rowElement.appendChild(cell);
            this_1.sheetBody.appendChild(rowElement);
        };
        var this_1 = this;
    ...
    RCEditor.prototype.handleCellKeyDown = function (event, cell, row) {
        // Alt+Enter 换行
    ...
    RCEditor.prototype.moveToNextRow = function (currentRow) {
        var _a;
        var nextRow = currentRow + 1;
        var nextCell = this.sheetBody.querySelector(".sheet-row[data-row=\"".concat(nextRow, "\"] .sheet-cell"));
        if (nextCell) {
            (_a = this.activeCell) === null || _a === void 0 ? void 0 : _a.classList.remove('editing');
            nextCell.focus();
        }
        else {
            // 如果已经是最后一行，添加新行
            this.addNewRow();
            var newCell = this.sheetBody.querySelector(".sheet-row:last-child .sheet-cell");
            newCell.focus();
        }
    };
    RCEditor.prototype.moveToNextCell = function (currentRow) {
        // RC编辑器只有一列，所以Tab键行为与Enter相同
        this.moveToNextRow(currentRow);
    };
    RCEditor.prototype.addNewRow = function () {
        var _this = this;
        var rows = this.sheetBody.querySelectorAll('.sheet-row');
        ...
        // 添加事件监听器
        cell.addEventListener('focus', function () { return _this.handleCellFocus(cell, newRowNum); });
        cell.addEventListener('blur', function () { return _this.handleCellBlur(cell, newRowNum); });
        cell.addEventListener('input', function () { return _this.handleCellInput(cell, newRowNum); });
        cell.addEventListener('keydown', function (e) { return _this.handleCellKeyDown(e, cell, newRowNum); });
        rowElement.appendChild(cell);
        this.sheetBody.appendChild(rowElement);
        // 在RC列表中添加新项
        this.rcList.setText("", newRowNum - 1);
    };
    RCEditor.prototype.updateSheet = function () {
        var rows = this.sheetBody.querySelectorAll('.sheet-row');
        for (var i = 0; i < rows.length; i++) {
            var row = rows[i];
            var cell = row.querySelector('.sheet-cell');
            var text = this.rcList.getText(i);
            if (text) {
    ...
    RCEditor.prototype.handleCellFocus = function (cell, row) {
        if (this.activeCell) {
    ...
    RCEditor.prototype.handleCellBlur = function (cell, row) {
        cell.classList.remove('editing');
        this.adjustRowHeight(cell.parentElement);
        this.saveCellContent(cell, row);
    };
    RCEditor.prototype.handleCellInput = function (cell, row) {
        this.adjustRowHeight(cell.parentElement);
    };
    RCEditor.prototype.saveCellContent = function (cell, row) {
        var text = cell.textContent || '';
        this.rcList.setText(text, row - 1);
    };
    RCEditor.prototype.adjustRowHeight = function (rowElement) {
        var cell = rowElement.querySelector('.sheet-cell');
        cell.style.height = 'auto';
        var height = Math.max(30, cell.scrollHeight);
        rowElement.style.height = "".concat(height, "px");
        cell.style.height = '100%';
    };
    RCEditor.prototype.updateStatus = function (row) {
        this.statusText.textContent = "\u884C ".concat(row);
    };
    return RCEditor;
}());
// 初始化编辑器
document.addEventListener('DOMContentLoaded', function () {
    window.rcEditorApp = new RCEditor();
});
...
var mergeModules = __webpack_require__(209)
...
module.exports.getCodec = function getCodec (encoding) {
  if (!module.exports.encodings) {
    var raw = __webpack_require__(336)
...
module.exports.enableStreamingAPI = function enableStreamingAPI (streamModule) {
  ...
  var streams = __webpack_require__(792)(streamModule)
...
var streamModule
try {
  streamModule = __webpack_require__(403)
} catch (e) {}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var iconv = __importStar(__webpack_require__(249));
var RcList = /** @class */ (function () {
    ...
    function RcList() {
        ...
        this.gb = 0;
        this.load = false;
        this.firstItem = 0; // 链表首项，当前项
        this.addrSize = 0; // 偏移所用字节数，<64K时为2位，>64K为4位
        this.rcStrCode = 0; // RC字符串编码，0 = Unicode Big，1 = GB2312
        this.texts = [];
        this.load = false;
    }
    // 新建空列表
    RcList.createEmpty = function (filename, capacity) {
        var rcList = new RcList();
    ...
    // 读取文件
    RcList.prototype.readFile = function (filename) {
        return __awaiter(this, void 0, void 0, function () {
            var response, buffer, result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        buffer = _a.sent();
                        result = this.readRc(new Uint8Array(buffer));
                        this.load = result > 0;
                        return [2 /*return*/, this.load];
                    case 4:
                        e_1 = _a.sent();
                        console.error("读取文件错误:", filename, e_1);
                        return [2 /*return*/, false];
    ...
    RcList.prototype.readData = function (filename, data) {
        this.filename = filename;
        var result = this.readRc(data);
        this.load = result > 0;
        return this.load;
    };
    RcList.prototype.readRc = function (rc) {
        if (rc.length < 10)
            return -1;
        var rcInt = [];
        for (var i = 0; i < rc.length / 2; i++) {
            var r1 = rc[i * 2];
            var r2 = rc[i * 2 + 1];
        ...
        // 自动检测编码：检查文件末尾的结束符模式
        this.detectEncoding(rc);
        var endPtr = this.findEndPointer(rcInt, rc);
        console.log("信息: endptr", endPtr);
        var math = this.calculateItemCount(rcInt, rc, endPtr);
        this.parseRcItems(rc, rcInt, math);
        return math;
    };
    RcList.prototype.detectEncoding = function (rc) {
        // 默认 Unicode Big
        this.rcStrCode = RcList.UNICODE_BIG;
        // 寻找最后一个字符串的结束符位置（从文件末尾向前找第一个0字节）
        for (var i = rc.length - 1; i >= 0; i--) {
            if (rc[i] === 0) {
                // 检查结束符模式：如果前一个字节不是0，则为单字节结束符 (GB2312)
                if (i > 0 && rc[i - 1] !== 0) {
                    this.rcStrCode = RcList.GB2312;
                }
                // 双字节结束符的情况，保持 UNICODE_BIG
                break;
            }
        }
        console.log("检测到编码:", this.rcStrCode === RcList.GB2312 ? "GB2312" : "Unicode Big");
        // 如果检测到 GB2312，还可以额外检查文件开头是否有 BOM 等，但保持简单
    };
    RcList.prototype.findEndPointer = function (rcInt, rc) {
        if (this.rcStrCode === RcList.GB2312) {
            // GB2312: 查找最后一个字符串结束标志（单个0x00）
            for (var i = rc.length - 1; i >= 0; i--) {
                if (rc[i] === 0) {
                    // 返回该位置在 rcInt 中的大致索引（向下取整）
            ...
            for (var i = rcInt.length - 2; i >= 0; i--) {
                if (rcInt[i] === 0) {
                    return i + 1;
                }
            }
    ...
    // 计算条目数量
    RcList.prototype.calculateItemCount = function (rcInt, rc, endPtr) {
        var math = 1;
        var rOffset = 0;
        var tempOffset;
        var itemCountGuess = Math.min(rcInt.length, 1000); // 防止无限循环
        while (math < itemCountGuess) {
            tempOffset = rOffset;
            rOffset = rcInt[math] / 2;
            if (tempOffset >= rOffset)
                break;
            if (rOffset >= (rcInt.length - math))
                break;
            // 验证当前偏移指向的字符串是否以正确的结束符结尾
            var stringStartByte = rcInt[math] + math * 2; // 偏移表中的偏移 + 偏移表大小
            var isValid = this.validateStringEnd(rc, stringStartByte);
            if (!isValid)
                break;
    ...
    RcList.prototype.validateStringEnd = function (rc, startByte) {
        if (startByte >= rc.length)
            return false;
        var pos = startByte;
        if (this.rcStrCode === RcList.GB2312) {
            // 寻找单个 0x00
            while (pos < rc.length && rc[pos] !== 0) {
                pos++;
            }
            return pos < rc.length && rc[pos] === 0;
        }
        else {
            // 寻找双字节 0x0000
            while (pos + 1 < rc.length && !(rc[pos] === 0 && rc[pos + 1] === 0)) {
                pos += 2;
            }
            return pos + 1 < rc.length && rc[pos] === 0 && rc[pos + 1] === 0;
        }
    };
    RcList.prototype.parseRcItems = function (rc, rcInt, itemCount) {
        this.texts = [];
        for (var i = 0; i < itemCount; i++) {
            var temp = new Uint8Array(rc.length);
            this.wstrcpy(temp, rc, rcInt[i] + itemCount * 2);
            this.texts[i] = this.unToChars(temp);
        }
    };
    RcList.prototype.save = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, blob, url, a;
            return __generator(this, function (_a) {
                if (!this.filename) {
...
{}
    ...
    RcList.prototype.getData = function () {
        try {
    ...
    RcList.prototype.buildSaveData = function () {
        var itemCount = this.size();
        // 第一步：为每个字符串生成编码后的字节数组（不含结束符）
        var encodedItems = [];
        var totalBodySize = 0;
        for (var i = 0; i < itemCount; i++) {
            var bytes = this.getBytesForSave(this.getText(i));
            encodedItems.push(bytes);
            totalBodySize += bytes.length;
            // 结束符长度：GB2312为1字节0x00，Unicode Big为2字节0x00 0x00
            totalBodySize += (this.rcStrCode === RcList.GB2312 ? 1 : 2);
        }
        // 第二步：构建偏移表（每个条目2字节，小端序）
        var headerSize = itemCount * 2;
        var data = new Uint8Array(headerSize + totalBodySize);
        var offset = 0;
        // 写入偏移表
        var currentOffset = 0; // 相对于字符串数据区起始的偏移（字节数）
        for (var i = 0; i < itemCount; i++) {
            data[offset] = currentOffset & 0xff;
            data[offset + 1] = (currentOffset >> 8) & 0xff;
            offset += 2;
            currentOffset += encodedItems[i].length;
            currentOffset += (this.rcStrCode === RcList.GB2312 ? 1 : 2);
        }
        // 第三步：写入字符串数据和结束符
        for (var i = 0; i < itemCount; i++) {
            data.set(encodedItems[i], offset);
            offset += encodedItems[i].length;
            // 写入结束符
            if (this.rcStrCode === RcList.GB2312) {
                data[offset] = 0;
                offset += 1;
    ...
    RcList.prototype.getBytesForSave = function (str) {
        if (this.rcStrCode === RcList.GB2312) {
            // 使用 iconv-lite 编码 GB2312
            var encoded = iconv.encode(str, 'gb2312');
            return new Uint8Array(encoded);
        }
        else {
            // Unicode Big (UTF-16BE)
            return this.stringToUtf16BeArray(str);
        }
    };
    RcList.prototype.size = function () {
        return this.texts.length;
    };
    RcList.prototype.getText = function (n) {
        if (n < 0 || n >= this.texts.length) {
            return "";
        }
        return this.texts[n];
    };
    RcList.prototype.setText = function (text, n) {
        if (n >= 0 && n < this.texts.length) {
            this.texts[n] = text;
        }
    };
    RcList.prototype.addBack = function (text) {
        this.texts.splice(this.gb + 1, 0, text);
    };
    RcList.prototype.addHead = function (text) {
        this.texts.splice(this.gb, 0, text);
    };
    RcList.prototype.remove = function (i) {
        if (i >= 0 && i < this.texts.length) {
            this.texts.splice(i, 1);
        }
    };
    RcList.prototype.stringToUtf16BeArray = function (str) {
    ...
    RcList.prototype.getBytes = function (str) {
        return this.stringToUtf16BeArray(str);
    };
    RcList.prototype.unToChars = function (temp) {
        if (this.rcStrCode === RcList.GB2312) {
            // 使用 iconv-lite 解码 GB2312
            return iconv.decode(Buffer.from(temp.slice(0, this.wstrlen(temp))), 'gb2312');
        }
        else {
    ...
    RcList.prototype.wstrcpy = function (dest, src, srcStart) {
        if (this.rcStrCode === RcList.GB2312) {
            // GB2312: 单字节结束符0x00
            var i = 0;
            while (srcStart + i < src.length && i < dest.length && src[srcStart + i] !== 0) {
    ...
    RcList.prototype.wstrlen = function (temp) {
        if (this.rcStrCode === RcList.GB2312) {
            var i = 0;
...
var StringDecoder = (__webpack_require__(876).StringDecoder)
