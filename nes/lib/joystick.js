...
Joystick.prototype.init = function(){
    ...
    //阻止默认事件，防止快速点击时页面缩放
    //兼容 el 传入 DOM 元素或选择器字符串两种情况
    var zoneEl = (typeof me.el === 'string') ? document.querySelector(me.el) : me.el;
    if (zoneEl && zoneEl.addEventListener) {
        zoneEl.addEventListener('touchstart',function(evt){
            evt.preventDefault()
        })
    }
}
